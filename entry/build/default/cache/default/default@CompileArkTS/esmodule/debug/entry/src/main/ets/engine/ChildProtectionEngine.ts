import type { FamilyMember, FoodNutrition } from '../model/FoodAdapterTypes';
...
export class ChildProtectionEngine {
     ...
     * @returns 儿童正餐建议
     */
    static getChildMealAdvice(member: FamilyMember, food: FoodNutrition, currentTime: Date, nextMealTime: Date): ChildMealAdvice {
        const result = new ChildMealAdvice();
        ...
        // 规则5：距下一餐1-2小时
        if (diffToMeal > 60 && diffToMeal <= 120 && (isSweet || isFat)) {
            result.affectMeal = true;
